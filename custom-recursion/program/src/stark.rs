...
use sp1_custom_recursion_compiler::ir::Array;
use sp1_custom_recursion_compiler::ir::Ext;
use sp1_custom_recursion_compiler::ir::SymbolicExt;
use sp1_custom_recursion_compiler::ir::SymbolicVar;
use sp1_custom_recursion_compiler::ir::Var;
use sp1_custom_recursion_compiler::ir::{Builder, Config, Usize};
use sp1_custom_recursion_compiler::prelude::Felt;

use sp1_custom_recursion_core::runtime::DIGEST_SIZE;
...
pub(crate) mod tests {
    ...
    use sp1_custom::runtime::CustomProgram;
    use sp1_custom::stark::CustomAir;
    use sp1_custom_recursion_compiler::config::InnerConfig;
    use sp1_custom_recursion_compiler::ir::Array;
    use sp1_custom_recursion_compiler::ir::Config;
    use sp1_custom_recursion_compiler::ir::Felt;
    use sp1_custom_recursion_compiler::prelude::Usize;
    use sp1_custom_recursion_compiler::{
        asm::AsmBuilder,
        ir::{Builder, ExtConst},
    };

    use sp1_custom_recursion_core::air::RecursionPublicValues;
    use sp1_custom_recursion_core::air::RECURSION_PUBLIC_VALUES_COL_MAP;
    use sp1_custom_recursion_core::air::RECURSIVE_PROOF_NUM_PV_ELTS;
    use sp1_custom_recursion_core::runtime::RecursionProgram;
    use sp1_custom_recursion_core::runtime::Runtime;
    use sp1_custom_recursion_core::runtime::DIGEST_SIZE;

    use sp1_custom_recursion_core::stark::utils::run_test_recursion;
    use sp1_custom_recursion_core::stark::utils::TestConfig;
    use sp1_custom_recursion_core::stark::RecursionAir;
    ...
    fn test_permutation_challenges() {
        ...
        let (_, vk) = machine.setup(&CustomProgram {});
        let mut challenger_val = machine.config().challenger();
        let (proof, _) = sp1_custom::utils::prove(
            CustomProgram {},
            &SP1Stdin::new(),
            SC::default(),
            SP1CoreOpts::default(),
