...
use sp1_custom_recursion_compiler::prelude::Config;
use sp1_custom_recursion_compiler::prelude::ExtConst;
use sp1_custom_recursion_compiler::prelude::{Builder, Ext, SymbolicExt};
...
mod tests {
    ...
    use sp1_core::{
        ...
        runtime::Program,
        stark::{
            Chip, Com, Dom, OpeningProof, PcsProverData, ShardCommitment, ShardMainData,
    ...
    use sp1_custom_recursion_core::stark::utils::{run_test_recursion, TestConfig};

    use p3_challenger::{CanObserve, FieldChallenger};
    use sp1_custom_recursion_compiler::{asm::AsmBuilder, ir::Felt, prelude::ExtConst};
    ...
    fn get_shard_data<'a, SC>(
        machine: &'a StarkMachine<SC, CustomAir<SC::Val>>,
        proof: &'a ShardProof<SC>,
        challenger: &mut SC::Challenger,
    ) -> (
        Vec<&'a Chip<SC::Val, CustomAir<SC::Val>>>,
        Vec<Dom<SC>>,
        Vec<Vec<Dom<SC>>>,
        Vec<SC::Challenge>,
        SC::Challenge,
