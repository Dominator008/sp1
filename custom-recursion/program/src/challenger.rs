...
use sp1_custom_recursion_compiler::prelude::MemIndex;
use sp1_custom_recursion_compiler::prelude::MemVariable;
use sp1_custom_recursion_compiler::prelude::Ptr;
use sp1_custom_recursion_compiler::prelude::Variable;
use sp1_custom_recursion_compiler::prelude::{
    Array, Builder, Config, DslVariable, Ext, Felt, Usize, Var,
};
use sp1_custom_recursion_core::runtime::HASH_RATE;
use sp1_custom_recursion_core::runtime::{DIGEST_SIZE, PERMUTATION_WIDTH};
...
mod tests {
    ...
    use sp1_custom_recursion_compiler::asm::AsmBuilder;
    use sp1_custom_recursion_compiler::asm::AsmConfig;
    use sp1_custom_recursion_compiler::ir::Felt;
    use sp1_custom_recursion_compiler::ir::Usize;
    use sp1_custom_recursion_compiler::ir::Var;

    use sp1_custom_recursion_core::runtime::PERMUTATION_WIDTH;
