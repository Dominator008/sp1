...
mod tests {
    ...
    use sp1_core::stark::{MachineVerificationError, StarkGenericConfig};
    ...
    fn test_sp1_recursive_machine_verify(program: CustomProgram, batch_size: usize, test: Test) {
        ...
        let machine = CustomAir::machine(SC::default());
    ...
    fn test_sp1_recursive_machine_verify_fibonacci() {
        ...
        test_sp1_recursive_machine_verify(CustomProgram {}, 1, Test::Recursion)
    }
    ...
    fn test_sp1_reduce_machine_verify_fibonacci() {
        let elf = include_bytes!("../../../../tests/fibonacci/elf/riscv32im-succinct-zkvm-elf");
        test_sp1_recursive_machine_verify(CustomProgram {}, 1, Test::Reduce)
    }
    ...
    fn test_sp1_compress_machine_verify_fibonacci() {
        let elf = include_bytes!("../../../../tests/fibonacci/elf/riscv32im-succinct-zkvm-elf");
        test_sp1_recursive_machine_verify(CustomProgram {}, 1, Test::Compress)
    }
    ...
    fn test_sp1_wrap_machine_verify_fibonacci() {
        let elf = include_bytes!("../../../../tests/fibonacci/elf/riscv32im-succinct-zkvm-elf");
        test_sp1_recursive_machine_verify(CustomProgram {}, 1, Test::Wrap)
    }
    ...
    fn test_sp1_reduce_machine_verify_tendermint() {
        ...
        test_sp1_recursive_machine_verify(CustomProgram {}, 2, Test::Reduce)
    }
    ...
    fn test_sp1_recursive_machine_verify_tendermint() {
        ...
        test_sp1_recursive_machine_verify(CustomProgram {}, 2, Test::Recursion)
    }
    ...
    fn test_sp1_compress_machine_verify_tendermint() {
        ...
        test_sp1_recursive_machine_verify(CustomProgram {}, 2, Test::Compress)
    }
    ...
    fn test_sp1_wrap_machine_verify_tendermint() {
        ...
        test_sp1_recursive_machine_verify(CustomProgram {}, 2, Test::Wrap)
    }
}
