...
use sp1_custom_recursion_compiler::ir::{Builder, Config, Felt};
use sp1_custom_recursion_compiler::prelude::*;
use sp1_custom_recursion_core::stark::config::OuterChallengeMmcs;
...
pub mod tests {
    ...
    use sp1_custom_recursion_core::stark::config::{
