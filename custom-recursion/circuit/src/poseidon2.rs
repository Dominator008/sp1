...
use sp1_custom_recursion_compiler::ir::{Builder, Config, DslIr, Var};
...
pub mod tests {
    ...
    use sp1_custom_recursion_compiler::ir::{Builder, Felt, Var, Witness};
    use sp1_custom_recursion_core::stark::config::{outer_perm, OuterCompress, OuterHash};
