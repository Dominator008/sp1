...
use sp1_custom_recursion_compiler::ir::ExtensionOperand;
use sp1_custom_recursion_compiler::ir::Felt;
use sp1_custom_recursion_compiler::ir::{Builder, Config, Ext};
use sp1_custom_recursion_compiler::prelude::SymbolicExt;
...
mod tests {
    ...
    use sp1_custom_recursion_gnark_ffi::PlonkBn254Prover;
