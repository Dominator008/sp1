...
use sp1_custom_recursion_compiler::ir::{Builder, Config, Felt, Var};
...
mod tests {
    ...
    use sp1_custom_recursion_compiler::constraints::ConstraintCompiler;
    use sp1_custom_recursion_compiler::ir::SymbolicExt;
    use sp1_custom_recursion_compiler::ir::{Builder, Witness};
    use sp1_custom_recursion_core::stark::config::{outer_perm, OuterChallenger};
