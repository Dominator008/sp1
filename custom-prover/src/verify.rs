...
use sp1_custom_recursion_gnark_ffi::{PlonkBn254Proof, PlonkBn254Prover};
use thiserror::Error;

use crate::{
    CoreSC, CustomCoreProofData, CustomProver, CustomReduceProof, CustomVerifyingKey, HashableKey,
    OuterSC,
};
...
impl CustomProver {
    ...
    pub fn verify_compressed(
        &self,
        proof: &CustomReduceProof<BabyBearPoseidon2>,
        vk: &CustomVerifyingKey,
    ) -> Result<(), MachineVerificationError<CoreSC>> {
    ...
    pub fn verify_wrap_bn254(
        &self,
        proof: &CustomReduceProof<BabyBearPoseidon2Outer>,
        vk: &CustomVerifyingKey,
